...
{ 
    ...
    node* ite_012 = mgr.ite_rec(mgr.projection(0), mgr.projection(1), mgr.projection(2));
    ...
    node* ite_210 = mgr.ite_rec(mgr.projection(2), mgr.projection(1), mgr.projection(0));
